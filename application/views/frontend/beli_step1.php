						...
						<div class="card mb-5">
							...
							<div class="card-body">
								<ul>
									...
									<li>► Berangkat Waktu <b>at <?php echo $jadwal['jam_berangkat_jadwal']; ?></b></li>
									<li>► Jam Kedatangan <b>at <?php echo $jadwal['jam_tiba_jadwal']; ?> </b></li>
									<li>► Silahkan pilih tempat duduk</li>
									...
									<tr>
										...
										<td class='btn-group' width='139'>
											...
											<label class='btn btn-primary'>
												<a value='' autocomplete='off' disabled='disabled'>Kursi Supir</a>
											</label>
										</td>
									</tr>
									<tr>
											...
											<div class="col-lg-4">
												...
												<div class="card mb-5">
													...
													<div class="alert alert-success" role="alert">
														<p>Setelah memilih kursi, silahkan klik tombol 'Next' untuk melanjutkan.</p>
														<div class='btn-group'>
