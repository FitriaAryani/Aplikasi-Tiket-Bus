        ...
        <div class="card-body">
          <div class="card-body">
            <div class="row">
                ...
                <form action="<?= base_url()?>backend/jadwal/tambahjadwal" method="post">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="asal" required>
                      <option value="" selected disabled="">-Choose Asal-</option>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="tujuan" required>
                      <option value="" selected disabled="">-Choose Tujuan-</option>
                      <?php foreach ($tujuan as $row ) {?>
                      <option value="<?= $row['kd_tujuan'] ?>" ><?= strtoupper($row['kota_tujuan'])." - ".$row['terminal_tujuan']; ?></option>
                      <?php } ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  id="time" name="berangkat" required="" placeholder="Jam">
                  </div>
                  <div class="form-group">
                    <label  class="">Tiba</label>
                    <input type="text" class="form-control"  id="time2" name="tiba" required="" placeholder="Jam">
                  </div>
                  <div class="form-group">
              ...
              <input  type="submit" class="btn btn-success pull-rigth" value="Tambah Jadwal">
            </form>
          </div>
        </div>
      </div>
