              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="row form-group">
                    <label for="nama" class="col-sm-4 control-label">Kode Pemesanan</label>
                    <div class="col-sm-8">
                  ...
                  <div class="row form-group">
                    <label for="" class="col-sm-4 control-label">Umur</label>
                    <div class="col-sm-8">
                  ...
                  <div class="row form-group">
                    <label for="" class="col-sm-4 control-label">Tanggal Pembayaran</label>
                    <div class="col-sm-8">
