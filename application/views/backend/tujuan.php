            ...
            <thead class="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=  substr($row['terminal_tujuan'], 0); ?></td>
      ...
      <form action="<?= base_url() ?>backend/rute/tambahtujuan" method="post" >
        <div class="form-group">
          <div class="form-label-group">
            <input type="text" id="tujuan" name="tujuan" class="form-control" placeholder="Daerah Tujuan" required="required" autofocus="autofocus">
          </div>
        </div>
        <div class="form-group">
          <div class="form-label-group">
            <input type="text" id="terminal" name="terminal" class="form-control" placeholder="Terminal" required="required" autofocus="autofocus">
          </div>
        </div>
