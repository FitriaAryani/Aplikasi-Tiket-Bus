...
class Login extends CI_Controller {
	...
	public function daftar(){
		...
		if ($this->form_validation->run() == false) {
			...
			$this->session->set_flashdata('message', 'swal("Berhasil", "Berhasil Registrasi. Welcome to Website!", "success");');
    		redirect('login');
		}
	...
	Private function _sendmail($token='',$type=''){
        ...
        $this->email->from('PT Anugerah Mas');
        $this->email->to($this->input->post('email'));
        // $this->email->attach('https://masrud.com/content/images/20181215150137-codeigniter-smtp-gmail.png');
        if ($type == 'verify') {
        	$this->email->subject('Account verify PT Anugerah Mas');
        	...
        	$this->email->subject('PT Anugerah Mas Ticket Reset Account');
